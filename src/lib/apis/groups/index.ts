...
export const getPublicGroups = async (token: string = '') => {
	let error = null;

	const res = await fetch(`${WEBUI_API_BASE_URL}/groups/public`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getMyGroups = async (token: string = '') => {
	...
	const res = await fetch(`${WEBUI_API_BASE_URL}/groups/my`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const joinGroup = async (token: string, groupId: string) => {
	let error = null;

	const res = await fetch(`${WEBUI_API_BASE_URL}/groups/join`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const leaveGroup = async (token: string, groupId: string) => {
	...
	const res = await fetch(`${WEBUI_API_BASE_URL}/groups/leave`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
